...
- **Groq API** — LLM (`openai/gpt-oss-20b`) para consultas RAG y resúmenes, Whisper (`whisper-large-v3-turbo`) para transcribir notas de voz y visión (`qwen3.6-27b`) para describir imágenes
